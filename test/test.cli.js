...
tape( 'the command-line interface prints the number of grapheme clusters', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
...
tape( 'when invoked with a `-l` flag, the command-line interface prints the number of grapheme clusters for individual lines', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
...
tape( 'when used as a standard stream with `-l` flag, the command-line interface prints the number of grapheme clusters for each line', opts, function test( t ) {
	var cmd = [
		'printf "beep\nboop🌷"',
		'|',
		EXEC_PATH,
